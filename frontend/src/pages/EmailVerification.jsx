...
const EmailVerification = () => {
    ...
    const handleChange = (index, value) => {
        ...
        if(value.length > 1 ){
            ...
            // Move focus to the next input filled if value is entered
            if(value && index < 5){
    ...
    return (
        <div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'>
            <motion.div
                ...
                <h1 className='mb-6 text-3xl font-bold text-center bg-gradient-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text'>Verify Your Email</h1>
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <motion.button className='mt-5 w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold rounded-lg shadow-lg 
